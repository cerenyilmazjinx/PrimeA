...
#[derive(Debug)]
pub struct PrimeAProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeAProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeA processing");
    
    let mut processor = PrimeAProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeAProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeAProcessor::new(false);
